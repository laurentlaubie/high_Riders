...
final class Version20210924125752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE spot (id INT AUTO_INCREMENT NOT NULL, departement_id INT DEFAULT NULL, title VARCHAR(150) NOT NULL, image VARCHAR(2100) NOT NULL, description LONGTEXT NOT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(255) NOT NULL, longitude DOUBLE PRECISION DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, opening_hours VARCHAR(50) DEFAULT NULL, closed_hours VARCHAR(50) DEFAULT NULL, saison_date VARCHAR(50) DEFAULT NULL, numbers_users INT DEFAULT NULL, average_rating INT DEFAULT NULL, difficulty SMALLINT DEFAULT NULL, link VARCHAR(2100) DEFAULT NULL, price INT DEFAULT NULL, accessibility LONGTEXT DEFAULT NULL, s_like INT DEFAULT NULL, d_positif INT DEFAULT NULL, d_negatif INT DEFAULT NULL, track_number SMALLINT DEFAULT NULL, type_spot VARCHAR(50) NOT NULL, status SMALLINT DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', published_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', slug VARCHAR(255) DEFAULT NULL, INDEX IDX_B9327A73CCF9E01E (departement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
